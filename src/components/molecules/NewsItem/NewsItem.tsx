...
//TODO Link도 사용될 수 있음
const NewsItem = ({ category, source, timestamp, title, summary, className, ...props }: NewsItemProps) => {
  const { root, newsInfoWrapper, categoryText, sourceDateWrapper, titleText, contentText } = newsItemVariants();
