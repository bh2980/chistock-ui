...
export const Default: Story = {
  render: () => <StockLogo src={IMAGE_URL} ticker={"CHST"} alt="chistock logo" className="w-[48rem] h-[48rem]" />,
};

export const WrongImageUrl: Story = {
  render: () => <StockLogo src="iamwrongurl" ticker={"CHST"} alt="chistock logo" className="w-[48rem] h-[48rem]" />,
};
